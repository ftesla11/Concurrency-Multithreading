...
public class NNDFS implements NDFS {
    ...
    public static ConcurrentHashMap<State, Boolean> Red = new ConcurrentHashMap<>();
    public static ConcurrentHashMap<State, Integer> Count = new ConcurrentHashMap<>();
