...
// Implementation of algorithm 2 from Laarman using ReadWrite locks
...
public class Worker implements Callable {
    ...
    private boolean isRed(State s) {
        NNDFS.redLock.readLock().lock();
        try {
            return NNDFS.Red.get(s) != null;
        } finally {
            NNDFS.redLock.readLock().unlock();
        }
    }
